        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <label for="chk_customer_name" class="control-label">Customer Name</label>
                    <select class="custom-select checkout-input" name="chk_customer_name" id="chk_customer_name" required="required">
                        <option value="" hidden>Select Customer Name</option>
                        <?php foreach($customers->fetch_all(MYSQLI_ASSOC) as $cust): ?>
                        <option id="<?= $cust['name'] ?>" data-address="<?= $cust['home_address'] ?>" data-contact="<?= $cust['contact_number'] ?>" value="<?= $cust['name'] ?>" ><?= $cust['name'] ?></option>
                        <?php endforeach; ?>
                    </select>
