                            ...
                            <tr onclick="cart_items(`+product_id+`)">
                                ...
                                <td class="text-primary product_name">
                                    ...
                                    <div class="input-group my-3" style="max-width:150px">
                                        <span onclick="change_quantity_down('`+product_barcode+`', `+ product_id +`)" class="input-group-text" style="cursor: pointer;"><i class="fa fa-minus text-primary"></i></span>
                                ...
                                <td style="font-size:20px" class="retail_price`+product_id+` cart-row">
                                    ...
                                    <button onclick="remove_item(`+product_barcode+`, `+product_id+`)" class="float-end btn btn-danger btn-sm remove-item"><i class="fa fa-times"></i></button>
                                </td>
                            </tr>
                        `;
