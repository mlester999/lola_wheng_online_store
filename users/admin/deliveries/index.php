...
<div class="card card-outline rounded-0 card-navy ">
	<div class="card-header">
		<h3 class="card-title">List of Sales - For Delivery and Pick-Up</h3>
	</div>
	<div class="card-body">
                                    ...
                                    <tr>
                                        ...
                                        <td class="align-items-center" align="center">
                                            ...
                                            <div class="dropdown-menu" role="menu">
                                                <a class="dropdown-item " href="./?page=deliveries/view_sale&transaction_id=<?php echo $row['transaction_id']; ?>"><span class="fa fa-eye text-dark"></span> View</a>
                                                <div class="dropdown-divider"></div>
                                                <a class="dropdown-item edit_data" href="javascript:void(0)" data-session_id="<?php echo $row['session_id']; ?>" data-transaction_id="<?php echo $row['transaction_id']; ?>"><span class="fa fa-edit text-primary"></span> Edit</a>
                                            </div>
                                        </td>
                                    </tr>
                        <?php 
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-sm-4">
                            <div class="form-group d-flex">
                                <div class="custom-control custom-radio pr-2">
                                    <input class="custom-control-input custom-control-input-dark " type="radio" id="customRadio5" name="status" value="5" >
                                    <label for="customRadio5" class="custom-control-label">Picked Up</label>
                                </div>
                            </div>
                        </div>
...
<script>
    ...
    $('#UpdateSelectedRowModal #frm-modal-update-selected').submit(function(e){
        ...
        $.ajax({
            url:_base_url_+"classes/Deliveries.php?f=update_sale_selected",
            ...
            success:function(resp){
                if(typeof resp =='object' && resp.status == 'success'){
                    location.replace('./?page=deliveries');
