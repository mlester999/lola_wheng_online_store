<nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item ">
        <a href="./?page=pos" class="nav-link"> <i class="nav-icon fas fa-desktop"></i> POS </a>
      </li>
    </ul>
    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item dropdown user-menu">
        <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown">
          <img src="<?php echo base_url . $_settings->userdata('image_path');?>" class="user-image img-circle elevation-2" alt="User Image">
        ...
        <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
          ...
          <li class="user-header bg-primary">
            ...
            <p>
              <?php echo $_settings->userdata('full_name');?>
              <small>Member since <?php echo date('M d, Y',strtotime($_settings->userdata('date_added'))); ?></small>
            </p>
          </li>
          
          <!-- Menu Footer-->
          <li class="user-footer">
            <a href="./?page=myprofile" class="btn btn-default btn-flat">Profile</a>
