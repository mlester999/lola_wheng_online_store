                    ...
                    if (resp) {
                        ...
                        if (resp.status == 'success') {
                            if(resp.login_type == 1) {
                                location.replace(_base_url_ + 'users/admin');
                            } else if(resp.login_type == 2) {
                                location.replace(_base_url_ + 'users/manager');
                            } else if(resp.login_type == 3) {
                                location.replace(_base_url_ + 'users/cashier');
                            } else if(resp.login_type == 4) {
                                location.replace(_base_url_ + 'users/customer');
                            }
